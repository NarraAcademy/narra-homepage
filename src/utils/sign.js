...
export function sign(data) {
    ...
    let key = import.meta.env.PROD ? "&key=3GVxJe2dY0QWPnwYsgThHuplyltfAk5O" : "&key=089lwuzsnPDDVBE0QuVN2AuFBrlxBavK"
    // let key = "&key=3GVxJe2dY0QWPnwYsgThHuplyltfAk5O" //正式
    // // 	key = "&key=UY0bUxo4Kr6DE8z46xFerTe40jRamYh4" //正式
    // if (process.env.NODE_ENV === 'development') {
    //     key = "&key=089lwuzsnPDDVBE0QuVN2AuFBrlxBavK" //测试
    // }
    const str = arr.sort().join('&') + key;
    // console.log('before sign:', str)
