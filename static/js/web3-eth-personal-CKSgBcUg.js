...
import { E as n } from "./web3-types-DSrrWgZ8.js";

import "./web3-errors-hzVYhHGn.js";

import "./web3-eth-iban-75eRxAWM.js";

import { v as i, b as r } from "./web3-validator-BARD4gRE.js";

import "./setimmediate-DUOPLI_V.js";

import { h as o } from "./web3-eth-vWxzIr98.js";

import "./web3-eth-abi-eT7or4Ei.js";

import { Q as e, R as s, S as a, T as u, U as c, V as d, W as v, X as f, Y as h } from "./web3-rpc-methods-Df_8n9zL.js";

import { z as m, L as l } from "./web3-utils-CA0vZo5F.js";

var g = function(t, n, i, r) {
    return new (i || (i = Promise))((function(o, e) {
        function s(t) {
            try {
                u(r.next(t));
            } catch (n) {
...
class w extends t {
   ...
   */
    getAccounts() {
        return p(this, void 0, void 0, (function*() {
            return t = this.requestManager, g(void 0, void 0, void 0, (function*() {
                return (yield e(t)).map(m);
            }));
            var t;
        }));
    }
   ...
   */    newAccount(t) {
        return p(this, void 0, void 0, (function*() {
            return ((t, n) => g(void 0, void 0, void 0, (function*() {
                i.validate([ "string" ], [ n ]);
                const r = yield s(t, n);
                return m(r);
   ...
   */    unlockAccount(t, n, r) {
        return p(this, void 0, void 0, (function*() {
            return ((t, n, r, o) => g(void 0, void 0, void 0, (function*() {
                return i.validate([ "address", "string", "uint" ], [ n, r, o ]), a(t, n, r, o);
            })))(this.requestManager, t, n, r);
        }));
    }
    /**
   ...
   */    lockAccount(t) {
        return p(this, void 0, void 0, (function*() {
            return ((t, n) => g(void 0, void 0, void 0, (function*() {
                return i.validate([ "address" ], [ n ]), u(t, n);
            })))(this.requestManager, t);
        }));
    }
    /**
   ...
   */    importRawKey(t, n) {
        return p(this, void 0, void 0, (function*() {
            return ((t, n, r) => g(void 0, void 0, void 0, (function*() {
                return i.validate([ "string", "string" ], [ n, r ]), c(t, n, r);
            })))(this.requestManager, t, n);
        }));
    }
    /**
   ...
   */    sendTransaction(t, i) {
        return p(this, void 0, void 0, (function*() {
            return ((t, i, r, e) => g(void 0, void 0, void 0, (function*() {
                const s = o(i, n, {
                    transactionSchema: null == e ? void 0 : e.customTransactionSchema
                });
                return d(t, s, r);
            })))(this.requestManager, t, i, this.config);
        }));
    }
    /**
   ...
   */    sign(t, n, o) {
        return p(this, void 0, void 0, (function*() {
            return ((t, n, o, e) => g(void 0, void 0, void 0, (function*() {
                i.validate([ "string", "address", "string" ], [ n, o, e ]);
                const s = r(n) ? n : l(n);
                return f(t, s, o, e);
            })))(this.requestManager, t, n, o);
        }));
    }
    /**
   ...
   */    ecRecover(t, n) {
        return p(this, void 0, void 0, (function*() {
            return ((t, n, o) => g(void 0, void 0, void 0, (function*() {
                i.validate([ "string", "string" ], [ n, o ]);
                const e = r(n) ? n : l(n);
                return h(t, e, o);
            })))(this.requestManager, t, n);
        }));
