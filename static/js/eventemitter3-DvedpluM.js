import { g as e } from "./@ethereumjs-aMURc4PS.js";
...
!function(e) {
    ...
    function s(e, t, r, s, i) {
        ...
        return e._events[f] ? e._events[f].fn ? e._events[f] = [ e._events[f], c ] : e._events[f].push(c) : (e._events[f] = c, 
        e._eventsCount++), e;
    }
    function i(e, t) {
    ...
    c.prototype.eventNames = function() {
        ...
        var f, a, u = this._events[c], p = arguments.length;
        if (u.fn) {
            ...
            var v, h = u.length;
            for (a = 0; a < h; a++) switch (u[a].once && this.removeListener(e, u[a].fn, void 0, !0), 
            p) {
              case 1:
              ...
              default:
                if (!f) for (v = 1, f = new Array(p - 1); v < p; v++) f[v - 1] = arguments[v];
        ...
        if (c.fn) c.fn !== t || o && !c.once || r && c.context !== r || i(this, s); else {
        ...
        var t;
        return e ? (t = n ? n + e : e, this._events[t] && i(this, t)) : (this._events = new r, 
        this._eventsCount = 0), this;
    }, c.prototype.off = c.prototype.removeListener, c.prototype.addListener = c.prototype.on, 
    c.prefixed = n, c.EventEmitter = c, e.exports = c;
}(t);
