import { c as commonjsGlobal, g as getDefaultExportFromCjs } from "./@ethereumjs-aMURc4PS.js";

var assign = make_assign(), create$1 = make_create(), trim$1 = make_trim(), Global$5 = "undefined" != typeof window ? window : commonjsGlobal, util$6 = {
    assign: assign,
    create: create$1,
    trim: trim$1,
    bind: bind$1,
...
function make_assign() {
    return Object.assign ? Object.assign : function(e, t, r, n) {
        for (var o = 1; o < arguments.length; o++) each$7(Object(arguments[o]), (function(t, r) {
            e[r] = t;
        }));
        return e;
    };
...
function createStore(e, t, r) {
    ...
    var n = r ? "__storejs_" + r + "_" : "", o = r ? new RegExp("^" + n) : null;
    ...
    var a = {
        ...
        _assignPluginFnProp: function(e, t) {
            var r = this[t];
            this[t] = function() {
                var t = slice(arguments, 0), n = this;
                var o = [ function() {
                    if (r) return each$6(arguments, (function(e, r) {
                        t[r] = e;
                    })), r.apply(n, t);
                } ].concat(t);
                return e.apply(n, o);
        ...
        _addPlugin: function(e) {
            var t = this;
            if (isList(e)) each$6(e, (function(e) {
                t._addPlugin(e);
...
function _makeIEStorageElFunction() {
    ...
    var e, t, r, n = "script";
    try {
        (t = new ActiveXObject("htmlfile")).open(), t.write("<" + n + ">document.w=window</" + n + '><iframe src="/favicon.ico"></iframe>'), 
        t.close(), e = t.w.frames[0].document, r = e.createElement("div");
    } catch (o) {
        r = doc$1.createElement("div"), e = doc$1.body;
    }
    return function(t) {
        var n = [].slice.call(arguments, 0);
        n.unshift(r), e.appendChild(r), r.addBehavior("#default#userData"), r.load(storageName), 
        t.apply(this, n), e.removeChild(r);
    };
}
...
function each$2(e) {
    for (var t = doc.cookie.split(/; ?/g), r = t.length - 1; r >= 0; r--) if (trim(t[r])) {
        var n = t[r].split("="), o = unescape(n[0]);
        e(unescape(n[1]), o);
    }
}
...
localStorage_1, oldFFGlobalStorage, oldIEUserDataStorage, cookieStorage, sessionStorage_1, memoryStorage_1 ], json2$1 = {}, hasRequiredJson2;

function requireJson2() {
    return hasRequiredJson2 || (hasRequiredJson2 = 1, "object" != typeof JSON && (JSON = {}), 
    function() {
        ...
        function str(e, t) {
            ...
            "function" == typeof rep && (c = rep.call(t, e, c)), typeof c) {
              ...
              case "object":
                ...
                if (rep && "object" == typeof rep) for (a = rep.length, r = 0; r < a; r += 1) "string" == typeof rep[r] && (o = str(n = rep[r], c)) && i.push(quote(n) + (gap ? ": " : ":") + o); else for (n in c) Object.prototype.hasOwnProperty.call(c, n) && (o = str(n, c)) && i.push(quote(n) + (gap ? ": " : ":") + o);
                return o = 0 === i.length ? "{}" : gap ? "{\n" + gap + i.join(",\n" + gap) + "\n" + l + "}" : "{" + i.join(",") + "}", 
                gap = l, o;
            }
        }
...
const storage =  getDefaultExportFromCjs(store_legacy);
